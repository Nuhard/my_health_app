...
class EnhancedHealthSummaryService {
  static final EnhancedHealthSummaryService instance = EnhancedHealthSummaryService._init();
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  
  EnhancedHealthSummaryService._init();
